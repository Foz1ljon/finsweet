  ...
  <div class="bg-[#F4F6FC]">
    <div class="container lg:pb-[128px] pb-10">
      <div class="lg:grid lg:grid-cols-3 grid-cols-2 text-center lg:text-start">
        <div class="">
          <h3
            class="text-[#282938] font-semibold text-2xl lg:text-4xl lg:leading-[55px] mb-4 lg:w-[327px]"
          >
            What our clients say about us
          </h3>
          <p
            class="text-[#282938] font-normal text-base leading-7 lg:w-[327px] mb-4"
          >
            ...
            <div class="swiper-container overflow-hidden relative">
              <div class="swiper-wrapper">
                <div v-for="item in 3" :key="item" class="swiper-slide">
                  <h2
                    class="font-semibold text-xl lg:text-3xl lg:max-w-[800px]"
                  >
              ...
              <div
                class="flex lg:gap-2 justify-end absolute bottom-0 right-0 lg:right-5 z-30"
              >
                <button
                  @click="goToPrevSlide"
